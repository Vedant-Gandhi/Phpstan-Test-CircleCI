...
class Container_116b9c9a78 extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_116b9c9a78 $container)
			{
	...
	public function createServiceContainer(): Container_116b9c9a78
	{
		return $this;
	}
