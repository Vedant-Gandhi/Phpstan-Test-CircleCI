...
class Container_94019587ff extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_94019587ff $container)
			{
	...
	public function createService081(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					'/Users/vedant/Codebase/phpstan-test/vendor/*',
					'/Users/vedant/Codebase/phpstan-test/tests/bootstrap.php',
				],
				'analyse' => [],
			]
		);
	...
	public function createServiceContainer(): Container_94019587ff
	{
		return $this;
	}
